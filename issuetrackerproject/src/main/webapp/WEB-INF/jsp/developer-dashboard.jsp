...
<div class="navbar">
    <ul>
        <li><a href="/developerprojectpage?getid=${user.company_id}&user_id=${user.id}"> <i class="fa fa-solid fa-bars-progress"></i>  My Projects</a></li>
        <li><a href="/developerticketspage?id=${user.id}&company_id=${user.company_id}"> <i class=" fa fa-solid fa-ticket-simple"></i> My Tickets</a></li>
...
<div class="table-container">
    <div class="table-main-container">
        <div class="table-description">
            ...
            <h4> Welcome to developer dashboard</h4>
        </div>
